...
rands = [random() for i in range(10000)]
...
print (datetime.now()-timer) # How long did it take to add the points
print (list(tree.nearest((rands[50], rands[50], rands[50], rands[50]), 3)))
print (datetime.now()-timer)# How long did it take to query for the nearest 3 points